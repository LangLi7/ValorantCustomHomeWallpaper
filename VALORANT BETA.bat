...
REM Zufällig eine Datei im source_custom_wallpaper_folder auswählen und umbenennen
set /a count=0
...
ren "%random_file%" "%new_name%%file_extension%"

REM Kopiere die umbenannte Datei aus dem source_custom_wallpaper_folder ins destination_folder
xcopy "%source_custom_wallpaper_folder%\%new_name%%file_extension%" "%destination_folder%" /H /Y
